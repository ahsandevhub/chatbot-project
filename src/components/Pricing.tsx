...
const features: PlanFeature[] = [
  { name: "Credit Limits", intern: "2 credits per day", equityAnalyst: "1,000 credits per month", globalMacro: "5,000 credits per month" },
  { name: "Asset Classes", intern: "Equities", equityAnalyst: "Equities", globalMacro: "Equities, Crypto, Forex" },
  { name: "Stock Exchanges", intern: "NASDAQ, NYSE", equityAnalyst: "Top 5", globalMacro: "Top 10" },
  { name: "Extended Trading Hours", intern: "-", equityAnalyst: <Check className="h-5 w-5 text-black" />, globalMacro: <Check className="h-5 w-5 text-black" /> },
  { name: "Historical Data", intern: "1 year", equityAnalyst: "3 years", globalMacro: "5 years" },
  { name: "Intraday Data", intern: "-", equityAnalyst: <Check className="h-5 w-5 text-black" />, globalMacro: <Check className="h-5 w-5 text-black" /> },
];
        ...
        >
          <div className="text-center mb-16">
            <div className="inline-block mb-4">
              <span className="bg-black text-white py-1 px-4 rounded-md font-medium">Pricing</span>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="pricing-card pricing-card-highlight bg-white animate-fade-in [animation-delay:200ms]">
              <h3 className="text-2xl font-bold mb-3 font-inter">Equity Analyst</h3>
              <p className="text-gray-600 mb-6 font-inter">
              ...
              <Button 
                className="w-full mb-8 bg-black hover:bg-black/90 button-hover-effect font-inter"
              >
                Sign Up
              </Button>
            </div>
            ...
            <div className="pricing-card bg-white animate-fade-in [animation-delay:300ms]">
              <h3 className="text-2xl font-bold mb-3 font-inter">Global Macro</h3>
              <p className="text-gray-600 mb-6 font-inter">
          ...
          <div className="mt-16 max-w-6xl mx-auto overflow-x-auto">
            <div className="min-w-max">
              ...
              {features.map((feature, index) => (
                <div key={index} className="grid grid-cols-4 gap-8 py-4 border-b border-gray-200 font-inter">
